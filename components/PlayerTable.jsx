    ...
    <>
      <table className="w-full text-sm text-center rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                {playerData.map((data,key) => (
                    ...
                    <tr id={key} contentEditable={edit} suppressContentEditableWarning={true} key={key} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td className="px-8 py-4  text-center">
                            <a onClick={()=>EditPlayer(key)} style={{cursor:"pointer"}} href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">
